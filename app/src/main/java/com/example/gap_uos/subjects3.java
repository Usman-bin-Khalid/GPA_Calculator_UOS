...
public class subjects3 extends AppCompatActivity {
    EditText mark1, mark2, mark3;
    EditText credit1, credit2, credit3;
    Button Calculate;
    TextView Result;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_subjects3);
    ...
    private void calculateGPA() {
        ...
        double gpa = gpa1 + gpa2 + gpa3;
        double cc = creditHours1 + creditHours2 + creditHours3;
