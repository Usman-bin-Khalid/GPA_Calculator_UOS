...
public class subjects7 extends AppCompatActivity {

    EditText mark1, mark2, mark3, mark4, mark5, mark6, mark7;
    EditText credit1, credit2, credit3, credit4, credit5, credit6, credit7;
    Button Calculate;
    TextView Result;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subjects7);
    ...
    private void calculateGPA() {
        ...
        int marks7 = Integer.parseInt(mark7.getText().toString());
        ...
        int creditHours7 = Integer.parseInt(credit7.getText().toString());
        ...
        double gpa7 = calculateGradePoint7(marks7) * creditHours7;
    ...
    private double calculateGradePoint7(int marks7) {
        // Implement your own logic to map marks to grade points
        // This is just a simple example, you may need to adjust it based on your grading system
        if (marks7 >= 80) {
            return 4.0;
