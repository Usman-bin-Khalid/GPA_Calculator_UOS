...
public class subjects4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subjects4);
    ...
    private void calculateGPA() {
        ...
        double cc = creditHours1 + creditHours2 + creditHours3 + creditHours4;
