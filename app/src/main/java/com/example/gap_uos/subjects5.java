...
public class subjects5 extends AppCompatActivity {
    EditText mark1, mark2, mark3, mark4, mark5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subjects5);
    ...
    private void calculateGPA() {
        ...
        double cc = creditHours1 + creditHours2 + creditHours3 + creditHours4 + creditHours5;
